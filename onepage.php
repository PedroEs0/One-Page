  ...
  <div class="sidebar" id="sidebar">
    ...
    <div class="submenu">
      ...
      <div class="submenu-content">
        ...
        <a href="so.php#tipos">Tipos de SO</a>
        <a href="so.php#ejemplos">Ejemplos</a>
      </div>
    </div>
    <div class="submenu">
      ...
      <div class="submenu-content">
        ...
        <a href="gprocess.php#planificacion">Planificación</a>
        <a href="gprocess.php#comunicacion">Comunicación</a>
      </div>
    </div>
    <div class="submenu">
      <button class="submenu-btn">Gestión de Memoria</button>
      <div class="submenu-content">
        <a href="gmemory.php#ram">RAM</a>
        <a href="gmemory.php#virtual">Memoria Virtual</a>
        <a href="gmemory.php#gestion">Gestión</a>
      </div>
    </div>
    <div class="submenu">
      <button class="submenu-btn">Gestión de Almacenamiento</button>
      <div class="submenu-content">
        <a href="gstorage.php#tipos">Tipos</a>
        <a href="gstorage.php#archivos">Archivos</a>
        <a href="gstorage.php#seguridad">Seguridad</a>
      </div>
    </div>
